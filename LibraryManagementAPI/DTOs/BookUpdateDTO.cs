/*
    - BookUpdateDTO only contains fields that would need to be updated. Mimics CreateDTO because anything that can
    be input via Create process should be updateable. In case of erroneous input for example
